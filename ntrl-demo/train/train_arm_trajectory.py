#!/usr/bin/env python3
"""
Train NTField from trajectory data (RRT-generated paths).
...
Usage:
    cd ntrl-demo && python train/train_arm_trajectory.py --data_path ./datasets/arm/UR5_trajectory
"""
...
class FastTensorDataLoader:
    """Fast DataLoader for tensors (from model_train_metric)."""
...
def main():
    parser = argparse.ArgumentParser(description="Train NTField from trajectory data")
    ...
    # Copy model files to experiment folder
    import shutil
