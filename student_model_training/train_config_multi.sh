...
WANDB_ENABLED="true"
WANDB_RUN_NAME="multi_image_text_prompt_fusion_hybrid_0.5"
...
TRAIN_CKPT_NAME="best_z_goal_model_multi_hybrid_0.5_{run_name}.pth" # supports {run_name}
TRAIN_PCA_OUTPUT_DIR="/home/hojinsohn/VLM-NT/PI-VLA/output/pca_training_plots_multi"
